...
{    [self createbutton];
    ...
    drawingSlate = [[JAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"J.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    KViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"KViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    IViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"IViewController"];
