...
{    [self createbutton];
    ...
    drawingSlate = [[QAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"Q.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    RViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"RViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    PViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"PViewController"];
