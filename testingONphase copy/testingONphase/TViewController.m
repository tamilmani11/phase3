...
{    [self createbutton];
    ...
    drawingSlate = [[TAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"T.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    UViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"UViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    SViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"SViewController"];
