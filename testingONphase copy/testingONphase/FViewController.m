...
{    [self createbutton];
    ...
    drawingSlate = [[FAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"F.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
     GViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"GViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    EViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"EViewController"];
