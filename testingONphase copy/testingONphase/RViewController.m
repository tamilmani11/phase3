...
{    [self createbutton];
    ...
    drawingSlate = [[RAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"R.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    QViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"QViewController"];
