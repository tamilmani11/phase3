...
{    [self createbutton];
    ...
    drawingSlate = [[NAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"N.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    OViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"OViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    MViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"MViewController"];
