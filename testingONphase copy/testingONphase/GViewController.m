...
{    [self createbutton];
    ...
    drawingSlate = [[GAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"G.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    HViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"HViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    FViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"FViewController"];
