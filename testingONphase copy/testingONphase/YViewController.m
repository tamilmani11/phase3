...
{    [self createbutton];
    ...
    drawingSlate = [[YAlphabet alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}

-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"Y.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    XViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"XViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    ZViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"ZViewController"];
