...
{    [self createbutton];
    ...
    drawingSlate = [[KAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"K.jpg"]];
}
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    LViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"LViewController"];
...

{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main"
                                                         bundle:nil];
    JViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"JViewController"];
