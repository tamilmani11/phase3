...
{    [self createbutton];
    ...
    drawingSlate = [[MAlphabets alloc] initWithFrame:drawFrame];
    [self Alphabet:drawingSlate];
}
-(void)setImage
{
    [testimage setImage:[UIImage imageNamed:@"M.jpg"]];
}
...

{
    ...
    NViewController *bobj =
    [storyboard instantiateViewControllerWithIdentifier:@"NViewController"];
