...
- (void)viewDidLoad
{
    ...
    if (checkcountvar==0)
    {
        ...
        copyAtoZarray=[AtozObj LPointsArray];
    }
...
-(void)MethodL:(CGPoint)TouchLocation
{
    ...
    if(touchLocation.x>77 && touchLocation.x<=187)
    {
