...
- (void)viewDidLoad
{
    ...
    if (checkcountvar==0)
    {
        ...
        copyAtoZarray=[AtozObj QPointsArray];
    }
...
-(void)MethodQ:(CGPoint)TouchLocation
{
    ...
    if(touchLocation.x>316 && touchLocation.x<=374)
    {
        if(touchLocation.y>507 && touchLocation.y<=563)
        {
            if (checkcountvar==18 && checkcount[18]==0)
            {
                [drawingPath moveToPoint:CGPointMake(313, 504)];
                [drawingPath addLineToPoint:CGPointMake(374, 563)];
                checkcountvar++;
                checkcount[18]++;
    ...
    if(touchLocation.x>374 && touchLocation.x<=434)
    {
        if(touchLocation.y>563 && touchLocation.y<=622)
        {
            if (checkcountvar==19 && checkcount[19]==0)
            {
                [drawingPath moveToPoint:CGPointMake(374, 563)];
                [drawingPath addLineToPoint:CGPointMake(434, 622)];
                checkcountvar++;
                checkcount[19]++;
