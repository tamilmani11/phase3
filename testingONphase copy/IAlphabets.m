...
- (void)viewDidLoad
{
    ...
    if (checkcountvar==0)
    {
        ...
        copyAtoZarray=[AtozObj IPointsArray];
    }
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    [drawingPath moveToPoint:CGPointMake(256, 140)];
...
-(void)MethodI:(CGPoint)TouchLocation
{
    
    CGPoint touchLocation =TouchLocation;
    //start from top and trun towords left side
    //1
    if(touchLocation.x>252 && touchLocation.x<=256)
    {
        if(touchLocation.y>140 && touchLocation.y<=210)
        {
            if (checkcount[0]==0 && checkcountvar==0)
            {
                ...
                [drawingPath addLineToPoint:CGPointMake(256, 210)];
                checkcountvar++;
                checkcount[0]++;
     ...
     if(touchLocation.x>252 && touchLocation.x<=256)
    {
        if(touchLocation.y>210 && touchLocation.y<=290)
        {
            ...
            {
                [drawingPath moveToPoint:CGPointMake(256, 210)];
                [drawingPath addLineToPoint:CGPointMake(256, 290)];
                checkcountvar++;
     ...
     if(touchLocation.x>252 && touchLocation.x<=256)
    {
        if(touchLocation.y>290 && touchLocation.y<=352)
        {
            ...
            {
                [drawingPath moveToPoint:CGPointMake(256, 290)];
                [drawingPath addLineToPoint:CGPointMake(256, 352)];
                checkcountvar++;
    ...
    if(touchLocation.x>252 && touchLocation.x<=256)
    {
        if(touchLocation.y>352 && touchLocation.y<=435)
        {
            ...
            {
                [drawingPath moveToPoint:CGPointMake(256, 352)];
                [drawingPath addLineToPoint:CGPointMake(256, 435)];
    ...
    if(touchLocation.x>252 && touchLocation.x<=256)
    {
        if(touchLocation.y>435 && touchLocation.y<=514)
        {
            ...
            {
                [drawingPath moveToPoint:CGPointMake(256, 435)];
                [drawingPath addLineToPoint:CGPointMake(256, 514)];
    ...
    if(touchLocation.x>252 && touchLocation.x<=256)
    {
        if(touchLocation.y>514 && touchLocation.y<=593)
        {
            ...
            {
                [drawingPath moveToPoint:CGPointMake(256, 514)];
    ...
    if(touchLocation.x>135 && touchLocation.x<=209)
    {
        if(touchLocation.y>137 && touchLocation.y<=140)
        {
            if (checkcountvar==6 && checkcount[6]==0)
            {
                [drawingPath moveToPoint:CGPointMake(125, 140)];
    ...
    if(touchLocation.x>281 && touchLocation.x<=361)
    {
        if(touchLocation.y>137 && touchLocation.y<=140)
        {
            if (checkcountvar==8 && checkcount[8]==0)
            {
                ...
                [drawingPath addLineToPoint:CGPointMake(372, 140)];
                checkcountvar++;
                checkcount[8]++;
    ...
    if(touchLocation.x>120 && touchLocation.x<=195)
    {
        if(touchLocation.y>620 && touchLocation.y<=624)
        {
            if (checkcountvar==9 && checkcount[9]==0)
            {
                [drawingPath moveToPoint:CGPointMake(125, 624)];
                [drawingPath addLineToPoint:CGPointMake(195, 624)];
                checkcountvar++;
                checkcount[9]++;
    ...
    if(touchLocation.x>195 && touchLocation.x<=268)
    {
        if(touchLocation.y>620 && touchLocation.y<=624)
        {
            if (checkcountvar==10 && checkcount[10]==0)
            {
                [drawingPath moveToPoint:CGPointMake(195, 624)];
                [drawingPath addLineToPoint:CGPointMake(268, 624)];
                checkcountvar++;
                checkcount[10]++;
    ...
    if(touchLocation.x>268 && touchLocation.x<=344)
    {
        if(touchLocation.y>620 && touchLocation.y<=624)
        {
            if (checkcountvar==11 && checkcount[11]==0)
            {
                [drawingPath moveToPoint:CGPointMake(268, 624)];
                [drawingPath addLineToPoint:CGPointMake(372, 624)];
                checkcountvar++;
                checkcount[11]++;
